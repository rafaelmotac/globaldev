...
//@WebMvcTest(GlobalTransactionController.class)
...
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(GlobalTransactionControllerTest.class);
//
//    @Autowired
//    public GlobalTransactionControllerTest(
